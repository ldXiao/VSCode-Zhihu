...
export async function activate( context: vscode.ExtensionContext ) {
    ...
    zhihuMdParser.renderer.rules.table_open = () => {
        return "<table data-draft-node=\"block\" data-draft-type=\"table\" data-size=\"normal\" data-row-style=\"striped\"><tbody>";
    };
    zhihuMdParser.renderer.rules.table_close = () => {
        return "</tbody></table>";
    };
    ...
    vscode.commands.registerCommand( "zhihu.search", async () => {
        return searchService.getSearchItems();
    }
    );
